...
const deleteEditableRecord = ()=>{
  ...
  if(mode==="edit") {
    ...
    if(id_record) {deleteAsyncRecord(id_record)} else {
      alert("Sorry, we cant delete this record. Bcs we cant find its id")
    }
  }
}
    ...
    <div className="main-wraper-new-entry">
      ...
      />
        ...
        <div className="btnWraperNewEntry">
          ...
          <button className="delete_editMode_btn" onClick={deleteEditableRecord}>Delete</button>
        </div>
      </div>
    </div>
  );
