    ...
    <>
      ...
      {availableQuickTags.length > 0 && (
        <div className="quick-tags">
          <button onClick={()=>setAccess(!access)}>available colors...</button>
          {access &&
