...
export default function App() {
  ...
  return (
    <>
      <div style={{ position: 'fixed', zIndex: 10, padding: '10px', background: 'rgba(255,255,255,0.8)', borderRadius: '0 0 10px 0' }}>
        <button onClick={() => handleFilterChange('work?')}>work?</button>
        <button onClick={() => handleFilterChange('delete')} style={{ margin: '0 10px' }}>delete</button>
