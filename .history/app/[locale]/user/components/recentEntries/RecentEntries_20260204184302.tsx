'use client'
//types
import { AllTags_Records, FeelingOption } from "@/app/[locale]/new-entry/entry-types/types";
...
export default function RecentEntries({diaryRecords}:{diaryRecords: AllTags_Records["diaryRecords"]}) {
